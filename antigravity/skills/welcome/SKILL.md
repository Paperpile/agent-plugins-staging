---
name: welcome
description: Introduce the Paperpile integration for Antigravity and suggest where to start. Use when the user asks what Paperpile can do here, or invokes this with no instruction of their own.
---

# Paperpile for Antigravity
...
Re-run the tool and complete the browser sign-in Antigravity opens for the Paperpile server.
