---
name: welcome
description: Introduce the Paperpile integration for Claude Code and suggest where to start. Use when the user asks what Paperpile can do here, or invokes this with no instruction of their own.
---

# Paperpile for Claude Code
...
Run `/mcp`, pick the Paperpile server (`plugin:paperpile-stage:paperpile`), and complete the browser sign-in.
